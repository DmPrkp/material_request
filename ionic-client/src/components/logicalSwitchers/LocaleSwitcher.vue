...
function handleLocale(locale: string, availableLocales) {
  ...
  if (availableLocales.includes(locale)) { setLocale(locale); } else if (availableLocales.includes(localeNoRegion)) { setLocale(localeNoRegion); } else { setLocale(defaultLocale); }
}
