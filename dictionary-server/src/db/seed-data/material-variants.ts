...
export const materialVariants: MaterialVariant[] = [
  ...
  // Брус 6 м: длина × ширина × толщина. Раньше каждый размер был отдельным материалом.
  { id: 300, materialId: 30, paramValueIds: [6, 504, 524] },
  { id: 301, materialId: 30, paramValueIds: [6, 505, 525] },
  { id: 302, materialId: 30, paramValueIds: [6, 506, 526] },
  { id: 303, materialId: 30, paramValueIds: [6, 507, 527] },
  { id: 304, materialId: 30, paramValueIds: [6, 508, 528] },
  { id: 305, materialId: 30, paramValueIds: [6, 509, 529] },
  // Доска обрезная 6 м — так же.
  { id: 500, materialId: 50, paramValueIds: [6, 507, 521] },
  { id: 501, materialId: 50, paramValueIds: [6, 509, 521] },
  { id: 502, materialId: 50, paramValueIds: [6, 511, 521] },
  { id: 503, materialId: 50, paramValueIds: [6, 516, 522] },
  { id: 504, materialId: 50, paramValueIds: [6, 508, 522] },
  { id: 505, materialId: 50, paramValueIds: [6, 507, 523] },
  { id: 506, materialId: 50, paramValueIds: [6, 515, 523] },
  { id: 507, materialId: 50, paramValueIds: [6, 509, 524] },
  { id: 508, materialId: 50, paramValueIds: [6, 517, 524] },
  { id: 509, materialId: 50, paramValueIds: [6, 510, 524] },
  { id: 510, materialId: 50, paramValueIds: [6, 507, 524] },
  { id: 511, materialId: 50, paramValueIds: [6, 511, 524] },
];
