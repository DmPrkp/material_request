 ...
 * и на уже поднятом dev-стеке базы `company` не было бы без `down -v`, то есть без
 * потери данных остальных сервисов. На проде Postgres внешний, db/init там не запускается вовсе.
 */
